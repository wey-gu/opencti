...
const CaseRfiKnowledgeTimeLineComponent = ({
  caseData,
  dateAttribute,
...
export default createFragmentContainer(CaseRfiKnowledgeTimeLineComponent, {
  caseData: graphql`
    fragment CaseRfiKnowledgeTimeLine_case on CaseRfi
    @argumentDefinitions(
      types: { type: "[String]" }
      search: { type: "String" }
      orderBy: {
