const i18n = {
  messages: {
    'es-es': {
      ...
      'Relationships view': 'Vista de relaciones',
      ...
      Threats: 'Amenazas',
      entity_Activity: 'Actividad (auditoria)',
      ...
      'Update a picture': 'Actualizar una imagen',
      ...
      Order: 'Orden',
      'Order of Carousel': 'Orden del carrusel',
      ...
      Cases: 'Casos',
      Analysis: 'Análisis',
      'Cases & Analyses': 'Casos y Análisis',
      Events: 'Eventos',
      Arsenal: 'Arsenal',
      ...
      'File SHA512 hash': 'hash SHA512 del fichero',
      ...
      'entity_Kill-Chain-Phase': 'Fase de la «kill chain»',
      ...
      'relationship_originates-from': 'se origina en',
      ...
      sophistication_unknown: 'Desconocida',
      ...
      NOT: 'NO',
      operator_gt: 'después de',
      operator_lt: 'antes de',
      ...
      filter_published_gt: 'Publicado después de',
      filter_published_lt: 'Publicado antes de',
      filter_created_gt: 'Creado después de',
      filter_created_lt: 'Creado antes de',
      filter_created_at_gt: 'Ingerido después de',
      filter_created_at_lt: 'Ingerido antes de',
      ...
      filter_modified_gt: 'Actualizado después de',
      filter_modified_lt: 'Actualizado antes de',
      filter_valid_from_gt: 'Válido desde',
      filter_valid_until_lt: 'Válido hasta',
      ...
      filter_toCreatedAt_gt: 'Ingerido después',
      filter_toCreatedAt_lt: 'Ingerido antes',
      filter_x_opencti_organization_type: 'Tipo de organización',
      filter_x_opencti_reliability: 'Fiabilidad',
      filter_source_reliability: 'Fiabilidad del autor',
      filter_indicates: 'Indica',
      filter_indicates_not_eq: 'NO Indica',
      filter_containers: 'Casos y Análisis',
      ...
      filter_start_time_lt: 'Fecha de inicio antes',
      filter_start_time_gt: 'Fecha de inicio después',
      filter_stop_time_lt: 'Fecha de finalización antes',
      filter_stop_time_gt: 'Fecha de finalización después de',
      ...
      'Notification connector': 'Conector de notificación',
    ...
    'fr-fr': {
      ...
      'Do you want to delete this threat actor group?':
        'Souhaitez-vous supprimer cet acteur (groupe) ?',
      'Do you want to delete this threat actor individual?':
        'Souhaitez-vous supprimer cet acteur (individu) ?',
      'Do you want to delete this intrusion set?':
      ...
      'Create a threat actor group': 'Créer un acteur (groupe)',
      'Update a threat actor group': 'Modifier un acteur (groupe)',
      'Create a threat actor individual': 'Créer un acteur (individu)',
      'Update a threat actor individual': 'Modifier un acteur (individu)',
      ...
      'start investigation': 'Commencer une investigation',
      ...
      'Contextual view': 'Vue contextuelle',
      'Relationships view': 'Vue relations',
      ...
      Threats: 'Menaces',
      entity_Activity: 'Activité (audit)',
      ...
      'Pictures Management': 'Gestion des images',
      'Update a picture': 'Modifier une image',
      ...
      Order: 'Ordre',
      'Order of Carousel': 'Ordre du Carousel',
      'In Carousel': 'Carrousel',
      Options: 'Options',
      Author: 'Auteur',
      'of author': "de l'auteur",
      ...
      Cases: 'Cases',
      Arsenal: 'Arsenal',
      'Cases & Analyses': 'Cases et analyse',
      Evidences: '',
      Pattern: 'Motif',
      ...
      'File SHA512 hash': 'Condensat SHA512 de fichier',
      ...
      'entity_Stix-Core-Object': 'Entité et observable',
      ...
      entity_Label: 'Label',
      'entity_Kill-Chain-Phase': 'Phase de kill chain',
      ...
      'entity_Threat-Actor-Group': 'Acteur (groupe)',
      'entity_Threat-Actor-Individual': 'Acteur (individu)',
      'entity_threat-actor': 'Acteur',
      'entity_threat-actor-group': 'Groupe',
      'entity_threat-actor-individual': 'Individu',
      entity_Tool: 'Outil',
      entity_Channel: 'Canal',
      ...
      'relationship_originates-from': 'originaire de',
      ...
      sophistication_unknown: 'Inconnu',
      ...
      filter_published_gt: 'Publié après',
      filter_published_lt: 'Publié avant',
      filter_created_gt: 'Créé après',
      filter_created_lt: 'Créé avant',
      filter_created_at_gt: 'Ingéré après',
      filter_created_at_lt: 'Ingéré avant',
      ...
      filter_modified_gt: 'Modifié après',
      filter_modified_lt: 'Modifié avant',
      filter_valid_from_gt: 'Valid depuis',
      filter_valid_until_lt: "Valide jusqu'à",
      filter_x_opencti_score: 'Score',
      ...
      filter_toCreatedAt_gt: 'Ingéré après',
      filter_toCreatedAt_lt: 'Ingéré avant',
      filter_x_opencti_organization_type: "Type d'organisation",
      filter_x_opencti_reliability: 'Fiabilité',
      filter_source_reliability: "Fiabilité de l'auteur",
      filter_indicates: 'Indique',
      filter_indicates_not_eq: 'SANS Indique',
      filter_containers: 'Cases et analyse',
      ...
      filter_start_time_lt: 'Date de début avant',
      filter_start_time_gt: 'Date de début après',
      filter_stop_time_lt: 'Date de fin avant',
      filter_stop_time_gt: 'Date de fin après',
      ...
      'Notification connector': 'Connecteur de notification',
    ...
    'ja-jp': {
      ...
      'Contextual view': 'コンテキストビュー',
      'Relationships view': '関係ビュー',
      ...
      Individuals: '個人',
      Threats: '脅威',
      entity_Activity: '活動（監査）',
      entity_History: '歴史（知識）',
      entity_Threats: '脅威',
      entity_Case: '場合',
      ...
      'Pictures Management': '写真管理',
      'Update a picture': '写真を更新する',
      ...
      entity_Label: 'ラベル',
      'entity_Kill-Chain-Phase': 'キルチェーンフェーズ',
      ...
      'entity_threat-actor': '脅威アクター',
      'entity_threat-actor-group': '脅威アクター グループ',
      'entity_threat-actor-individual': '脅威アクター個人',
      entity_Tool: 'ツール',
      entity_Channel: 'チャネル',
      ...
      filter_published_gt: '公開日時(開始)',
      filter_published_lt: '公開日時(終了)',
      filter_created_gt: '作成日時(開始)',
      filter_created_lt: '作成日時(終了)',
      filter_created_at_gt: '作成日時(開始)',
      filter_created_at_lt: '作成日時(終了)',
      ...
      filter_modified_gt: '変更日時(開始)',
      filter_modified_lt: '変更日時(終了)',
      filter_valid_from_gt: '有効期間(開始)',
      filter_valid_until_lt: '有効期間(終了)',
      ...
      filter_toCreatedAt_gt: '作成日時(開始)',
      filter_toCreatedAt_lt: '作成日時(終了)',
      filter_x_opencti_organization_type: '組織種別',
      filter_x_opencti_reliability: '信頼性',
      filter_source_reliability: '著者の信頼性',
      filter_indicates: '指し示す',
      filter_indicates_not_eq: '指し示すなし',
      filter_containers: '事例と分析',
      filter_revoked: '失効',
      ...
      filter_participant: '参加者',
      filter_priority: '優先順位',
      filter_severity: '重大度',
      filter_is_read: '読まれる？',
      filter_start_time_lt: '開始日より前',
      filter_start_time_gt: '開始日以降',
      filter_stop_time_lt: '終了日より前',
      filter_stop_time_gt: '終了日以降',
      filter_source: 'ソース',
      filter_user_id: 'ユーザー',
      ...
      Notifiers: '通知エージェント',
      'Notification connector': '通知コネクタ',
      'Accessible for': 'アクセス可能',
      Test: 'テスト',
      'Testing notifier': 'テスト通知機能',
    ...
    'zh-cn': {
      ...
      'This item is built-in': '该项目是内置的',
      'Some fields in usage are mandatory': '使用中的某些字段是必填的',
      'Used in': '用于',
      Usages: '用途',
      Aliases: '别名',
      ...
      Individuals: '个体',
      Threats: '威胁',
      entity_Activity: '活动（审核）',
      entity_History: '历史（知识）',
      entity_Threats: '威胁',
      entity_Case: '案件',
      entity_Feedback: '反饋',
      'entity_Case-Incident': '事件',
      ...
      'Pictures Management': '图片管理',
      'Update a picture': '更新一张图片',
      ...
      'entity_threat-actor': '威胁源',
      'entity_threat-actor-group': '威胁参与者组',
      'entity_threat-actor-individual': '威胁行为者个人',
      entity_Tool: '攻击工具',
      entity_Channel: '渠道',
      entity_Narrative: '叙述',
      entity_Language: '语',
      ...
      filter_published_gt: '发布开始日期',
      filter_published_lt: '发布结束日期',
      filter_created_gt: '创建开始日期',
      filter_created_lt: '创建结束日期',
      filter_created_at_gt: '创建开始日期',
      filter_created_at_lt: '创建结束日期',
      filter_likelihood: '可能性',
      filter_likelihood_gt: '可能性大于',
      filter_likelihood_lte: '可能性低于或等于',
      filter_note_types: '筆記類型',
      filter_note_types_not_eq: '非筆記類型',
      filter_modified_gt: '修改开始日期',
      filter_modified_lt: '修改结束日期',
      filter_valid_from_gt: '有效期开始日期',
      filter_valid_until_lt: '有效期结束日期',
      ...
      filter_toCreatedAt_gt: '创建开始日期',
      filter_toCreatedAt_lt: '创建结束日期',
      filter_x_opencti_organization_type: '组织类型',
      filter_x_opencti_reliability: '可靠性',
      filter_source_reliability: '作者的可靠性',
      filter_indicates: '指示',
      filter_indicates_not_eq: '非指示',
      filter_containers: '案例与分析',
      filter_revoked: '撤销',
      ...
      filter_participant: '参与者',
      filter_priority: '优先',
      filter_severity: '严重性',
      filter_is_read: '是读？',
      filter_start_time_lt: '之前的開始日期',
      filter_start_time_gt: '之後的開始日期',
      filter_stop_time_lt: '之前的結束日期',
      filter_stop_time_gt: '之後的結束日期',
      filter_source: '来源',
      filter_user_id: '用戶',
      ...
      Notifiers: '通知器',
      'Notification connector': '通知连接器',
      'Accessible for': '适用于',
      Test: '测试',
      'Testing notifier': '測試通知程式',
      'Choose target': '選擇目標',
    ...
    'en-us': {
      ...
      filter_event_type_not_eq: 'NOT Event type',
      filter_event_types: 'Event type',
      filter_event_types_not_eq: 'NOT Event type',
      filter_context: 'Context',
      filter_context_not_eq: 'NOT Context',
      filter_published_gt: 'Published after',
      filter_published_lt: 'Published before',
      filter_created_gt: 'Created after',
      filter_created_lt: 'Created before',
      filter_created_at_gt: 'Ingested after',
      filter_created_at_lt: 'Ingested before',
      ...
      filter_modified_gt: 'Modified after',
      filter_modified_lt: 'Modified before',
      filter_valid_from_gt: 'Valid from',
      filter_valid_until_lt: 'Valid until',
      filter_x_opencti_score: 'Score',
      filter_x_opencti_negative: 'Qualification',
      ...
      filter_x_opencti_base_severity: 'CVSS3-Severity',
      filter_x_opencti_attack_vector: 'CVSS3-Attack vector',
      filter_toCreatedAt_gt: 'Ingested after',
      filter_toCreatedAt_lt: 'Ingested before',
      ...
      filter_containers: 'Cases & analysis',
      ...
      filter_start_time_lt: 'Start date before',
      filter_start_time_gt: 'Start date after',
      filter_stop_time_lt: 'End date before',
      filter_stop_time_gt: 'End date after',
      filter_source: 'Source',
      filter_user_id: 'User',
