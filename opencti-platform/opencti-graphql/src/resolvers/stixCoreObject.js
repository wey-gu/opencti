...
import {
  ...
  batchReports,
  findAll,
  findById, findFilterRepresentative, findFiltersRepresentatives,
...
const stixCoreObjectResolvers = {
  Query: {
    ...
    filterRepresentative: (_, { filter }, context) => findFilterRepresentative(context, context.user, filter),
