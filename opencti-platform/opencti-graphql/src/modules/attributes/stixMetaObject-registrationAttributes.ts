...
const stixMetaObjectsAttributes: { [k: string]: Array<AttributeDefinition> } = {
  [ENTITY_TYPE_MARKING_DEFINITION]: [
    ...
    { name: 'x_opencti_order', type: 'numeric', precision: 'integer', mandatoryType: 'external', multiple: false, upsert: false },
  ...
  [ENTITY_TYPE_KILL_CHAIN_PHASE]: [
    ...
    { name: 'x_opencti_order', type: 'numeric', precision: 'integer', mandatoryType: 'external', multiple: false, upsert: true },
  ],
};
