...
const stixCyberObservableAttributes: Array<AttributeDefinition> = [
  ...
  { name: 'x_opencti_score', type: 'numeric', precision: 'integer', mandatoryType: 'no', multiple: false, upsert: true },
];
...
const stixCyberObservablesAttributes: { [k: string]: Array<AttributeDefinition> } = {
  [ENTITY_AUTONOMOUS_SYSTEM]: [
    { name: 'number', type: 'numeric', precision: 'integer', mandatoryType: 'external', multiple: false, upsert: true },
  ...
  [ENTITY_EMAIL_MESSAGE]: [
    ...
    { name: 'attribute_date', type: 'date', mandatoryType: 'no', multiple: false, upsert: true },
  ...
  [ENTITY_HASHED_OBSERVABLE_STIX_FILE]: [
    ...
    { name: 'size', type: 'numeric', precision: 'long', mandatoryType: 'no', multiple: false, upsert: true },
    { name: 'name', type: 'string', mandatoryType: 'no', multiple: false, upsert: true },
  ...
  [ENTITY_HASHED_OBSERVABLE_X509_CERTIFICATE]: [
    ...
    { name: 'validity_not_before', type: 'date', mandatoryType: 'no', multiple: false, upsert: true },
    { name: 'validity_not_after', type: 'date', mandatoryType: 'no', multiple: false, upsert: true },
    { name: 'subject', type: 'string', mandatoryType: 'no', multiple: false, upsert: true },
    ...
    { name: 'private_key_usage_period_not_before', type: 'date', mandatoryType: 'no', multiple: false, upsert: true },
    { name: 'private_key_usage_period_not_after', type: 'date', mandatoryType: 'no', multiple: false, upsert: true },
  ...
  [ENTITY_NETWORK_TRAFFIC]: [
    ...
    { name: 'src_port', type: 'numeric', precision: 'integer', mandatoryType: 'no', multiple: false, upsert: true },
    { name: 'dst_port', type: 'numeric', precision: 'integer', mandatoryType: 'no', multiple: false, upsert: true },
    { name: 'protocols', type: 'string', mandatoryType: 'no', multiple: true, upsert: true },
    { name: 'src_byte_count', type: 'numeric', precision: 'integer', mandatoryType: 'no', multiple: false, upsert: true },
    { name: 'dst_byte_count', type: 'numeric', precision: 'integer', mandatoryType: 'no', multiple: false, upsert: true },
    { name: 'src_packets', type: 'numeric', precision: 'integer', mandatoryType: 'no', multiple: false, upsert: true },
    { name: 'dst_packets', type: 'numeric', precision: 'integer', mandatoryType: 'no', multiple: false, upsert: true },
  ],
  [ENTITY_PROCESS]: [
    { name: 'extensions', type: 'string', mandatoryType: 'no', multiple: false, upsert: true },
    ...
    { name: 'created_time', type: 'date', mandatoryType: 'no', multiple: false, upsert: true },
    ...
    // { name: 'startup_info', type: 'json', mandatoryType: 'no', multiple: false, upsert: false }, // TODO To introduce later
  ...
  [ENTITY_USER_ACCOUNT]: [
    ...
    { name: 'account_created', type: 'date', mandatoryType: 'no', multiple: false, upsert: true },
    { name: 'account_expires', type: 'date', mandatoryType: 'no', multiple: false, upsert: true },
    { name: 'credential_last_changed', type: 'date', mandatoryType: 'no', multiple: false, upsert: true },
    { name: 'account_first_login', type: 'date', mandatoryType: 'no', multiple: false, upsert: true },
    { name: 'account_last_login', type: 'date', mandatoryType: 'no', multiple: false, upsert: true },
  ],
  [ENTITY_WINDOWS_REGISTRY_KEY]: [
    ...
    { name: 'number_of_subkeys', type: 'numeric', precision: 'integer', mandatoryType: 'no', multiple: false, upsert: true },
  ],
  [ENTITY_WINDOWS_REGISTRY_VALUE_TYPE]: [
    { name: 'name', type: 'string', mandatoryType: 'no', multiple: false, upsert: true },
  ...
  [ENTITY_PAYMENT_CARD]: [
    ...
    { name: 'expiration_date', type: 'date', mandatoryType: 'no', multiple: false, upsert: true },
