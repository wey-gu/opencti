...
import {
  ...
  ENTITY_TYPE_USER, ENTITY_TYPE_HISTORY, ENTITY_TYPE_WORK, ENTITY_TYPE_ACTIVITY, ENTITY_TYPE_FEED,
...
const internalObjectsAttributes: { [k: string]: AttributeDefinition[] } = {
  [ENTITY_TYPE_SETTINGS]: [
    ...
    { name: 'password_policy_min_length', type: 'numeric', precision: 'integer', mandatoryType: 'no', multiple: false, upsert: false },
    { name: 'password_policy_max_length', type: 'numeric', precision: 'integer', mandatoryType: 'no', multiple: false, upsert: false },
    { name: 'password_policy_min_numbers', type: 'numeric', precision: 'integer', mandatoryType: 'no', multiple: false, upsert: false },
    { name: 'password_policy_min_symbols', type: 'numeric', precision: 'integer', mandatoryType: 'no', multiple: false, upsert: false },
    { name: 'password_policy_min_words', type: 'numeric', precision: 'integer', mandatoryType: 'no', multiple: false, upsert: false },
    { name: 'password_policy_min_lowercase', type: 'numeric', precision: 'integer', mandatoryType: 'no', multiple: false, upsert: false },
    { name: 'password_policy_min_uppercase', type: 'numeric', precision: 'integer', mandatoryType: 'no', multiple: false, upsert: false },
  ...
  [ENTITY_TYPE_CAPABILITY]: [
    ...
    { name: 'attribute_order', type: 'numeric', precision: 'integer', mandatoryType: 'no', multiple: false, upsert: false },
    { name: 'description', type: 'string', mandatoryType: 'no', multiple: false, upsert: false },
  ],
  [ENTITY_TYPE_CONNECTOR]: [
    { name: 'name', type: 'string', mandatoryType: 'no', multiple: false, upsert: false },
  ...
  [ENTITY_TYPE_STATUS]: [
    ...
    { name: 'order', type: 'numeric', precision: 'integer', mandatoryType: 'external', multiple: false, upsert: false },
  ],
  [ENTITY_TYPE_WORK]: [
    { name: 'name', type: 'string', mandatoryType: 'external', multiple: false, upsert: false },
    { name: 'timestamp', type: 'date', mandatoryType: 'no', multiple: false, upsert: false },
  ...
  [ENTITY_TYPE_BACKGROUND_TASK]: [
    ...
    { name: 'task_processed_number', type: 'numeric', precision: 'integer', mandatoryType: 'no', multiple: false, upsert: false },
    { name: 'task_expected_number', type: 'numeric', precision: 'integer', mandatoryType: 'no', multiple: false, upsert: false },
  ...
  [ENTITY_TYPE_RETENTION_RULE]: [
    ...
    { name: 'max_retention', type: 'numeric', precision: 'integer', mandatoryType: 'external', multiple: false, upsert: false },
    { name: 'last_execution_date', type: 'date', mandatoryType: 'no', multiple: false, upsert: false },
    { name: 'last_deleted_count', type: 'numeric', precision: 'integer', mandatoryType: 'no', multiple: false, upsert: false },
    { name: 'remaining_count', type: 'numeric', precision: 'integer', mandatoryType: 'no', multiple: false, upsert: false },
  ],
  [ENTITY_TYPE_SYNC]: [
    { name: 'name', type: 'string', mandatoryType: 'external', multiple: false, upsert: false },
